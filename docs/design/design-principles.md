...
FestFuse's color semantics and visual design principles. These govern all UI work
(`app/**/*.{tsx,css}`). The per-tool files (`.claude/rules/design-principles.md`,
`.cursor/rules/design-principles.mdc`, `.agents/skills/design-principles/SKILL.md`)
