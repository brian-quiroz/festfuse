...
heuristic — is in **`docs/process/artist-editorial-process.md`**. Read it and follow it.
Incident case studies are in `docs/process/artist-editorial-incidents.md`; read those
only when a check is getting shaky.
