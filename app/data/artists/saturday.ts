...
const cortis: Artist = {
  ...
  whatToExpect: [
    ...
    "Heavy hip-hop bass pockets",
    "High-fashion cinematic visual backing",
    "Intense localized fan-chant energy",
  ],
  bestFor: [
  ...
  tracks: [
    { name: "REDRED", album: "GREENGREEN", duration: "" },
    { name: "GO!", album: "Color Outside the Lines", duration: "" },
    { name: "FaSHioN", album: "Color Outside the Lines", duration: "" },
  ],
  about:
