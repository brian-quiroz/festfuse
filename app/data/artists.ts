...
const jennie: Artist = {
  ...
  vibes: ["Bold", "Y2K", "Fierce", "Glamorous", "Confident", "Pop"],
  fansOf: ["CL", "Doja Cat", "Cardi B", "BLACKPINK"],
  tracks: [
...
const beabadoobee: Artist = {
  ...
  vibes: ["Dreamy", "Fuzzy", "Nostalgic", "Lo-Fi", "Melancholic", "Indie"],
  fansOf: ["Mitski", "Phoebe Bridgers", "Soccer Mommy", "Japanese Breakfast"],
  tracks: [
...
const majorLazer: Artist = {
  ...
  vibes: ["Party", "Tropical", "High Energy", "Caribbean", "Festival", "Hypnotic"],
  fansOf: ["DJ Snake", "J Balvin", "Skrillex", "Diplo"],
  tracks: [
