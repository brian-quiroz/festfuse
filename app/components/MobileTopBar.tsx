...
// Mirrors Sidebar's own visibility checks so the two stay in lockstep — without this, a
// mobile user would see a hamburger that opens nothing during the Quick Picks
// decisioning/completion flow or on the no-context homepage picker, where Sidebar is
// hidden entirely.
export default function MobileTopBar() {
  ...
  const context = useActiveContextStore((state) => state.context);
