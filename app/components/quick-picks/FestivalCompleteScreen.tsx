...
export default function FestivalCompleteScreen({ onGoToBlueprint, onGoToSchedule }: Props) {
    ...
    function handleBlueprint() {
        ...
        setTimeout(() => { setPressingBlueprint(false); onGoToBlueprint(); }, 100);
    }

    function handleSchedule() {
        if (pressingSchedule) return;
        setPressingSchedule(true);
        setTimeout(() => { setPressingSchedule(false); onGoToSchedule(); }, 100);
    }
        ...
        >
            <div className="flex flex-col items-center gap-8 w-full max-w-xl text-center">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <p className="text-[#FF2D78] text-sm uppercase tracking-widest font-extrabold">Festival Complete</p>
                    <span className="h-px w-12 bg-[#FF2D78]/60" />
                </div>
                ...
                <div className="flex flex-col items-center gap-5 w-full mt-4">
                    ...
                    <p className="text-white/70 text-base">
                        Your festival is starting to take shape.
                    </p>
